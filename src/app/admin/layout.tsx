  ...
  return (
    <div className="admin-shell">
      <aside className="admin-sidebar">
        ...
        <nav className="admin-nav" aria-label="Admin navigation"><Link className="active" href="/admin">Overview</Link><Link href="/admin/products">Products</Link><Link href="/admin/orders">Orders</Link><Link href="/admin/support">Support</Link></nav>
