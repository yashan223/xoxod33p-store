...
const createLiquidEffect = (texture: THREE.Texture, opts?: LiquidOptions) => {
  ...
  return new Effect('LiquidEffect', fragment, {
    uniforms: new Map<string, THREE.Uniform<unknown>>([
      ['uTexture', new THREE.Uniform(texture) as unknown as THREE.Uniform<unknown>],
      ['uStrength', new THREE.Uniform(opts?.strength ?? 0.025) as unknown as THREE.Uniform<unknown>],
      ['uTime', new THREE.Uniform(0) as unknown as THREE.Uniform<unknown>],
      ['uFreq', new THREE.Uniform(opts?.freq ?? 4.5) as unknown as THREE.Uniform<unknown>]
    ])
  });
};
