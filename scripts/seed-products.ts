...
const products = [
  { id: "frontline-20", type: "server", name: "Frontline 20", description: "A ready-to-run public server for weekend warfare.", price: 12000, meta: "20 slots · EU West · NVMe", tag: "Popular", accent: "blue", active: true, available: true },
  { id: "frontline-40", type: "server", name: "Frontline 40", description: "More room for clan nights, tournaments, and full lobbies.", price: 22000, meta: "40 slots · EU West · NVMe", accent: "slate", active: true, available: true },
  { id: "scrim-elite", type: "server", name: "Scrim Elite", description: "Low-latency private hosting for serious competition.", price: 35000, meta: "24 slots · Frankfurt · Priority", tag: "Premium", accent: "indigo", active: true, available: true },
